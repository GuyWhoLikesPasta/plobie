-- ==============================================
-- CANONICAL RESTORE SQL
-- Complete database restoration from scratch.
-- Run this in Supabase SQL Editor to restore all tables, policies, and seed data.
...
-- ==============================================
-- PART 2: Additional tables, policies, features
-- (from COMPLETE_RESTORE.sql)
-- ==============================================
