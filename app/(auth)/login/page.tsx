    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-10 animate-slide-up">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-white mb-3">Welcome Back</h2>
          <p className="text-gray-400 text-base md:text-lg">Sign in to continue to your garden</p>
        </div>
        ...
        <div className="glass-strong rounded-3xl shadow-2xl p-8 md:p-10 border border-white/10">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 min-h-[52px] bg-gradient-to-r from-emerald-500 to-cyan-500 text-white rounded-xl font-bold hover:shadow-glow disabled:opacity-50 disabled:cursor-not-allowed transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center px-4 py-3.5 min-h-[48px] glass border border-white/10 rounded-xl hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              >
