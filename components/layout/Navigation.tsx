      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 min-h-[44px]">
            ...
            <span className="text-xl font-bold text-green-800 dark:text-green-400">Plobie</span>
          </Link>
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  className="text-sm text-gray-700 hover:text-green-600 dark:text-gray-300 dark:hover:text-green-400 font-medium hidden sm:inline transition"
                >
                  {user.email?.split('@')[0]}
                </Link>
                <button
                  onClick={handleSignOut}
                  className="px-4 py-2 min-h-[44px] flex items-center text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 rounded-lg transition"
                >
                  Sign Out
                </button>
              </div>
